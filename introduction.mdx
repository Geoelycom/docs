...
you might be prompted again to undergo some KYC(Know your customer) depending on the country you selected in this step. Please **Note**, the KYC process can be skipped if you don't feel comfortable providing this information.
...
<CardGroup cols={2}>
  <Card
    ...
    icon="pen-to-square"
    href="https://docs.easepay.io/development"
  >
    Get yourself set up and running locally for easy development
  </Card>
  <Card
    title="view our FAQS"
    icon="image"
